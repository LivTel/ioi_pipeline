...
def affineremap(filepath, transform, shape, alifilepath=None, outdir = "alipy_out", makepng=False, hdu=0, verbose=True, fitgeom="rscale"):
	"""
	...
	"""
	if fitgeom == "shift":
            transform.v[0] = 1  # remove rotation/scaling coefficients
            transform.v[1] = 0
        elif fitgeom == "rscale":
            pass
...
def irafalign(filepath, uknstarlist, refstarlist, shape, alifilepath=None, outdir = "alipy_out", makepng=False, hdu=0, verbose=True, fitgeom="rscale"):
	"""
	...
	iraf.geomap.fitgeom = fitgeom.lower()	# You can change this to : shift, xyscale, rotate, rscale
